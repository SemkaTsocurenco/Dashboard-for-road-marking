...
**Размер payload:** 8 bytes
**Общий размер кадра:** 20 bytes
...
2. **MARKING_OBJECTS** (0x02) - объекты разметки (базовая версия)
3. **LANE_DETAILS** (0x03) - детальные границы полосы
4. **MARKING_OBJECTS_EX** (0x04) - объекты разметки (расширенная версия)
5. **FITTED_LINES** (0x05) - полиномиальные кривые линий для 3D реконструкции

**Частота отправки:** ~10-30 Hz (зависит от скорости обработки видео)
